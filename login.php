              ...
              <form class="pt-3" method="POST" action="<?php echo $_SERVER['PHP_SELF'] ?>">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input name="username" type="text" class="form-control form-control-lg border-left-0" placeholder="Username">
                  </div>
                </div>
                <!--
                <div class="form-group">
...
<!--
                <div class="form-group">
                  <label>Country</label>
                  <select name="" class="form-control form-control-lg" id="exampleFormControlSelect2">
...
-->
                ...
                <div class="text-center mt-4 font-weight-light">
                  Create New Account? <a href="register.php" class="text-primary">Register</a>
                </div>
              </form>
